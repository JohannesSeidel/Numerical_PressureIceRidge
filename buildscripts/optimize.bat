...
gfortran -fopenmp -O3 -c ./sourcecode/mod_Force.f08
gfortran -fopenmp -O3 -c ./sourcecode/mod_Particle.f08
gfortran -O3 -c ./sourcecode/mod_ImportExport.f08
gfortran -fopenmp -O3 -c ./sourcecode/mod_PredCorr.f08
gfortran -O3 -c ./sourcecode/Main.f08

gfortran *.o -fopenmp -O3 -o NumRidge.exe
